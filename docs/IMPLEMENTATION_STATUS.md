...
| 2026-07-29 | Deploy step is indistinguishable from a hang | Initially added `arcalium-install-progress.sh`, but removed it 2026-07-31 because it started before the user completed Anaconda's wizard and therefore presented misleading progress. The welcome dialog still states 15–40 minutes up front. |
